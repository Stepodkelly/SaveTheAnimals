...
export async function loadDemoData() {
  ...
  const [scene, roads, floods, locations, v2ReplayCells, sentinelQuicklooks] = await Promise.all([
  ...
  return { scene, roads, floods, locations, v2ReplayCells, sentinelQuicklooks };
}
